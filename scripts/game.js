...
var GameObject = (function(_createjs$Container) {
  ...
  function GameObject(graphic) {
    ...
    var _this = _possibleConstructorReturn(
      this,
      (GameObject.__proto__ || Object.getPrototypeOf(GameObject)).call(this)
    );
...
var MoveableGameObject = (function(_GameObject) {
  _inherits(MoveableGameObject, _GameObject);

  function MoveableGameObject(graphic) {
    _classCallCheck(this, MoveableGameObject);

    var _this2 = _possibleConstructorReturn(
      this,
      (
        MoveableGameObject.__proto__ ||
        Object.getPrototypeOf(MoveableGameObject)
      ).call(this, graphic)
    );
  ...
  _createClass(MoveableGameObject, [
    {
      key: "tick",
      value: function tick() {
...
var Coin = (function(_GameObject2) {
  ...
  function Coin() {
    ...
    return _possibleConstructorReturn(
      this,
      (Coin.__proto__ || Object.getPrototypeOf(Coin)).call(
        this,
        new lib.CoinGraphic()
      )
    );
...
var Enemy = (function(_MoveableGameObject) {
  _inherits(Enemy, _MoveableGameObject);
...
var Hero = (function(_MoveableGameObject2) {
  _inherits(Hero, _MoveableGameObject2);
  ...
  function Hero() {
    ...
    return _possibleConstructorReturn(
      this,
      (Hero.__proto__ || Object.getPrototypeOf(Hero)).call(
        this,
        new lib.HeroGraphic()
      )
    );
...
var Platform = (function(_GameObject3) {
  ...
  function Platform() {
    ...
    return _possibleConstructorReturn(
      this,
      (Platform.__proto__ || Object.getPrototypeOf(Platform)).call(
        this,
        new lib.PlatformGraphic()
      )
    );
  }
  ...
  _createClass(World, [
    ...
    },
    {
      ...
      value: function generatePlatforms() {
        ...
        try {
          for (
            var _iterator = this.levelData.levels[Symbol.iterator](), _step;
            ...
            for (var i = 0; i < level.total; i++) {
              ...
              platform.setClippingWidth(
                width - Math.random() * level.widthDiff
              );
    ...
    },
    {
      ...
      value: function generateCoins() {
        ...
        try {
          for (
            var _iterator2 = this.platforms[Symbol.iterator](), _step2;
    ...
    },
    {
      ...
      value: function targetHitTestObjects(target, objects) {
        ...
        try {
          for (
            var _iterator3 = objects[Symbol.iterator](), _step3;
    ...
    },
    {
      ...
      value: function isObjectOnGround(object) {
        ...
        try {
          for (
            var _iterator4 = this.platforms[Symbol.iterator](), _step4;
    ...
    },
    {
      ...
      value: function willObjectOnGround(object) {
        ...
        try {
          for (
            var _iterator5 = this.platforms[Symbol.iterator](), _step5;
    ...
    },
    {
      ...
      value: function retinalize() {
        ...
        this.canvas.setAttribute(
          "height",
          Math.round(this.stage.height * ratio)
        );
